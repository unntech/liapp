...
switch ($style) {
    case 'svg':
        LiPhp\qrCode::svg($data, $size, $margin, $level, $saveAndPrint, false, $back_color, $fore_color);
        break;
    case 'eps':
        LiPhp\qrCode::eps($data, $size, $margin, $level, $saveAndPrint, false, $back_color, $fore_color);
        break;
    case 'text':
        $text = LiPhp\qrCode::text($data, $size, $margin, $level, false);
        echo json_encode($text);
        break;
    default:
        LiPhp\qrCode::png($data, $size, $margin, $level, $saveAndPrint, false, $back_color, $fore_color);
}